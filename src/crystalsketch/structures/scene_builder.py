...
from crystalsketch.structures.summary import (
    build_structure_summary,
    has_valid_3d_periodic_cell,
)
from crystalsketch.structures.warning_policy import suppress_third_party_structure_warnings
...
def _build_scene_spec(
    ...
    *,
    ...
    polyhedra = []
    warnings = []
    if bond_cutoff_overrides:
        bond_failure_context = "Custom bonding recalculation"
    elif include_connectivity is True:
        bond_failure_context = "Connectivity calculation"
    else:
        bond_failure_context = None
        ...
        try:
            ...
            warnings.append(
                _analysis_failure(
                    ...
                    bond_algorithm=selected_bond_algorithm,
                    exc=exc,
                    fatal_context=bond_failure_context,
                )
            )
        else:
            atom_index_by_key = {
