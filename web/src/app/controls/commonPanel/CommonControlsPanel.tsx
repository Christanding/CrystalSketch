...
export type CommonPanelTab = "camera" | "display" | "style" | "export" | "tools";
...
const COMMON_PANEL_TABS: {
  Icon: LucideIcon;
  labelKey: "nav.display" | "nav.pose" | "nav.style" | "nav.export" | "nav.tools";
  ...
  { Icon: Download, labelKey: "nav.export", value: "export" },
  { Icon: Ruler, labelKey: "nav.tools", value: "tools" },
];
...
export function CommonControlsPanel({
  ...
  structureExportContent?: ReactNode;
      ...
      >
        ...
        <Tabs value={activeTab} onValueChange={handleTabValueChange}>
          ...
          >
            ...
            <TabsContent value="tools">{toolsContent}</TabsContent>
