...
import sakuraSkyColormap from "../data/colormaps/presets/sakura-sky.json";
import apricotIceColormap from "../data/colormaps/presets/apricot-ice.json";
import irisApricotColormap from "../data/colormaps/presets/iris-apricot.json";
...
import paulTolBrightColormap from "../data/colormaps/presets/paul-tol-bright.json";
import rosePineDawnColormap from "../data/colormaps/presets/rose-pine-dawn.json";
import tableau10Colormap from "../data/colormaps/presets/tableau-10.json";
import moonrise3Colormap from "../data/colormaps/presets/moonrise-3.json";
import royal2Colormap from "../data/colormaps/presets/royal-2.json";
import {
...
const STATIC_COLORMAP_MODULES: Record<string, unknown> = {
  "../data/colormaps/presets/summer-meadow.json": summerMeadowColormap,
  "../data/colormaps/presets/sakura-sky.json": sakuraSkyColormap,
  "../data/colormaps/presets/apricot-ice.json": apricotIceColormap,
  ...
  "../data/colormaps/presets/paul-tol-bright.json": paulTolBrightColormap,
  "../data/colormaps/presets/rose-pine-dawn.json": rosePineDawnColormap,
  "../data/colormaps/presets/tableau-10.json": tableau10Colormap,
  "../data/colormaps/presets/moonrise-3.json": moonrise3Colormap,
  "../data/colormaps/presets/royal-2.json": royal2Colormap,
...
export function colorSchemeTokenStyle(colorScheme: ColorScheme, elements?: readonly string[]): CSSProperties {
  return colormapTokenStyle(colormapById(colorScheme), elements);
}
...
function colormapTokenStyle(colormap: Colormap, elements?: readonly string[]): CSSProperties {
  const presentElements = [...new Set(elements)].filter(element => colormap.elements[element] !== undefined).slice(0, 4);
  const tokenElements = presentElements.length ? presentElements : colormap.tokenElements;
  const stops = tokenElements.map((element, index) => {
    const start = (index / tokenElements.length) * 100;
    const end = ((index + 1) / tokenElements.length) * 100;
